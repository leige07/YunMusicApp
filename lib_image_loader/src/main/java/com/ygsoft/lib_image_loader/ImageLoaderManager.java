...
import com.ygsoft.lib_image_loader.R;
import com.ygsoft.lib_image_loader.image.CustomRequestListener;
import com.ygsoft.lib_image_loader.image.Utils;
...
public class ImageLoaderManager {
    ...
    private RequestOptions initCommonRequestOption(int width, int height) {
        RequestOptions options = new RequestOptions();
        options.placeholder(R.mipmap.b4y)
                .error(R.mipmap.b4y)
                .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
